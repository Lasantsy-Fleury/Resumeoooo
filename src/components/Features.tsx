...
export default function Features() {
  return (
    <section id="features" className="py-24 sm:py-32 bg-surface-card">
      <div className="max-w-6xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 stagger-children">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="group p-6 rounded-2xl bg-white border border-surface-divider hover:border-accent/20 transition-all duration-300 hover:-translate-y-1"
              style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.04)' }}
            >
              <div className="w-12 h-12 rounded-xl bg-accent-pill flex items-center justify-center mb-5 text-accent group-hover:scale-110 transition-transform duration-300">
                {feature.icon}
              </div>
